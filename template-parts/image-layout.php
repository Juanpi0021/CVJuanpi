        ...
        <div class="entry-attachment">
            ...
            <?php if ( has_excerpt() ) : ?>
                <div class="entry-caption">
                    <p><?php $vw_landing_page_excerpt = get_the_excerpt(); echo esc_html( vw_landing_page_string_limit_words( $vw_landing_page_excerpt, esc_attr(get_theme_mod('vw_landing_page_excerpt_number','30')))); ?></p>
                </div>
            <?php endif; ?>
        </div>
        <?php
