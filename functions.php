...
/* Breadcrumb Begin */
function vw_landing_page_the_breadcrumb() {
	if (!is_home()) {
		echo '<a href="';
...
function vw_landing_page_setup() {
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'vw-landing-page') {
		wp_redirect(admin_url('themes.php?page=vw_landing_page_guide'));
	}
}
endif;
...
function vw_landing_page_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=vw_landing_page_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-landing-page' ) .'</a></span>';
		echo '<span class="demo-btn"><a href="'. esc_url( 'https://www.vwthemes.net/vw-landing-page-pro/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'VIEW DEMO', 'vw-landing-page' ) .'</a></span>';
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/themes/wordpress-landing-page-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-landing-page' ) .'</a></span>';
	echo '</div>';
}
...
function vw_landing_page_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Social Icon', 'vw-landing-page' ),
		'description'   => __( 'Appears on right side footer', 'vw-landing-page' ),
		'id'            => 'footer-icon',
...
function vw_landing_page_scripts() {
	...
	wp_enqueue_script( 'vw-landing-page-custom-scripts', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );

	if (get_theme_mod('vw_landing_page_animation', true) == true){
...
function vw_landing_page_tagline_hide_show(){
	if(get_theme_mod('vw_landing_page_tagline_hide_show',0) == '1' ) {
		return true;
	}
	return false;
}

add_action( 'wp_ajax_vw_landing_page_reset_all_settings', 'vw_landing_page_reset_all_settings' );
function vw_landing_page_reset_all_settings() {
	remove_theme_mod( 'vw_landing_page_slider_hide_show' );
	remove_theme_mod( 'vw_landing_page_slider_page' );
	remove_theme_mod( 'vw_landing_page_slider_button_text' );
	remove_theme_mod( 'vw_landing_page_slider_button_icon' );
	remove_theme_mod( 'vw_landing_page_slider_content_hide_show' );
	remove_theme_mod( 'vw_landing_page_slider_content_option' );
	remove_theme_mod( 'vw_landing_page_slider_content_padding_top_bottom' );
	remove_theme_mod( 'vw_landing_page_slider_content_padding_left_right' );
	remove_theme_mod( 'vw_landing_page_slider_excerpt_number' );
	remove_theme_mod( 'vw_landing_page_slider_opacity_color' );
	remove_theme_mod( 'vw_landing_page_slider_height' );
	remove_theme_mod( 'vw_landing_page_slider_speed' );

	remove_theme_mod( 'vw_landing_page_footer_background_color' );
	remove_theme_mod( 'vw_landing_page_footer_text' );
	remove_theme_mod( 'vw_landing_page_copyright_font_size' );
	remove_theme_mod( 'vw_landing_page_copyright_padding_top_bottom' );
	remove_theme_mod( 'vw_landing_page_copyright_alignment' );
	remove_theme_mod( 'vw_landing_page_hide_show_scroll' );
	remove_theme_mod( 'vw_landing_page_scroll_top_icon' );
	remove_theme_mod( 'vw_landing_page_scroll_to_top_font_size' );
	remove_theme_mod( 'vw_landing_page_scroll_to_top_padding' );
	remove_theme_mod( 'vw_landing_page_scroll_to_top_width' );
	remove_theme_mod( 'vw_landing_page_scroll_to_top_height' );
	remove_theme_mod( 'vw_landing_page_scroll_to_top_border_radius' );
	remove_theme_mod( 'vw_landing_page_scroll_top_alignment' );
...
//Active Callback
function vw_landing_page_default_slider(){
	if(get_theme_mod('vw_landing_page_slider_type', 'Default slider') == 'Default slider' ) {
		return true;
	}
	return false;
}

function vw_landing_page_advance_slider(){
	if(get_theme_mod('vw_landing_page_slider_type', 'Default slider') == 'Advance slider' ) {
		return true;
	}
	return false;
}

function vw_landing_page_blog_post_featured_image_dimension(){
	if(get_theme_mod('vw_landing_page_blog_post_featured_image_dimension') == 'custom' ) {
		return true;
	}
	return false;
}
